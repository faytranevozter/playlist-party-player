...
<template>
  <div>
        <div id="player" class="hidden">
          ...
          >
            <div class="flex items-center space-x-4">
              <img
                src="https://lh3.googleusercontent.com/iEZF6i3V3KL02o0DrmOy4ZkD0BCW8pUy08X1w2UvkcwcdMZiFXxl8wsL4JTBqgIVD0wG56lp6Z6F10h6=w120-h120-l90-rj"
                alt=""
                width="88"
                height="88"
              ...
              <div class="min-w-0 flex-auto space-y-1 font-semibold">
                ...
                <p class="text-slate-900 dark:text-slate-50 text-lg truncate">
                  Mocca
                </p>
              </div>
            </div>
        ...
        <div id="next" class="mt-2 space-y-1">
          <div class="flex items-center space-x-2 rounded-md bg-slate-600">
            <img
              src="https://lh3.googleusercontent.com/iEZF6i3V3KL02o0DrmOy4ZkD0BCW8pUy08X1w2UvkcwcdMZiFXxl8wsL4JTBqgIVD0wG56lp6Z6F10h6=w120-h120-l90-rj"
              alt=""
              width="88"
            ...
            />
            <div class="min-w-0 flex-auto space-y-1 font-semibold">
              <p class="text-cyan-500 dark:text-cyan-400 text-sm">Friends</p>
              <h2
                class="text-slate-500 dark:text-slate-400 text-sm max-w-md truncate"
              >
                On The Night Like This
              </h2>
              <p class="text-slate-900 dark:text-slate-50 text-md truncate">
                Mocca
              </p>
            </div>
          </div>
          <div class="flex items-center space-x-2 rounded-md bg-slate-600">
            <img
              src="https://lh3.googleusercontent.com/UYQW9rnsBJuiD64XArnu5sn_2K0aZsiosoH0STvO50lHKx_5mQQ0BX8MNB99Si4QqBUI3QJah7iTm-peKg=w60-h60-l90-rj"
              alt=""
              width="88"
              height="88"
              class="flex-none rounded-lg bg-slate-100"
            ...
            />
            <div class="min-w-0 flex-auto space-y-1 font-semibold">
              <p class="text-cyan-500 dark:text-cyan-400 text-sm">Grateful</p>
              <h2
                class="text-slate-500 dark:text-slate-400 text-sm max-w-md truncate"
              >
                I'm the One (feat. Justin Bieber, Quavo, Chance the Rapper & Lil
                Wayne)
              </h2>
              <p class="text-slate-900 dark:text-slate-50 text-md truncate">
                DJ Khaled
